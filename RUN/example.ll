...
; Function Attrs: alwaysinline nounwind readnone
define { { { i64 } } } @_Foo_S.S.i64({ { i64 } } %"$0") #1 {
entry:
  %"$0.fca.0.0.extract" = extractvalue { { i64 } } %"$0", 0, 0
  %.fca.0.0.0.insert = insertvalue { { { i64 } } } undef, i64 %"$0.fca.0.0.extract", 0, 0, 0
  ret { { { i64 } } } %.fca.0.0.0.insert
}
