...
define void @main() #0 {
entry:
  tail call void @"_$print_i64"(i64 2) #0
  ret void
}

; Function Attrs: alwaysinline nounwind
define { { i64 } } @_Foo_S.i64({ i64 } %w) #1 {
entry:
  %w.fca.0.extract = extractvalue { i64 } %w, 0
  tail call void @"_$print_i64"(i64 %w.fca.0.extract)
  %.fca.0.0.insert = insertvalue { { i64 } } undef, i64 %w.fca.0.extract, 0, 0
  ret { { i64 } } %.fca.0.0.insert
}

; Function Attrs: alwaysinline nounwind readnone
define { { i64 } } @_Foo_S.i641({ i64 } %"$0") #2 {
entry:
