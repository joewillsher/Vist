...
entry:
  ...
  %2 = bitcast { i8*, i32 }* %storage.i.i to %Foo.refcounted*
  tail call void @vist_retainObject({ i8*, i32 }* %storage.i.i)
  %3 = bitcast { i8*, i32 }* %storage.i.i to %Foo**
  %4 = load %Foo** %3, align 8
  %a.i.i = getelementptr inbounds %Foo* %4, i64 0, i32 0
  store %Int { i64 4 }, %Int* %a.i.i, align 8
  ...
  call void @vist_deallocUnownedObject({ i8*, i32 }* %8)
  ret void
}
