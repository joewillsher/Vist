...
define void @main() {
entry:
  call void @foo_tI(%Int { i64 1 })
  %0 = call %String @String_topi64b(i8* getelementptr inbounds ([6 x i8]* @0, i32 0, i32 0), i64 6, i1 true), !stdlib.call.optim !0
  call void @print_tString(%String %0), !stdlib.call.optim !0
  %1 = call %String @String_topi64b(i8* getelementptr inbounds ([14 x i8]* @1, i32 0, i32 0), i64 14, i1 false), !stdlib.call.optim !0
...
entry:
  call void @print_tI(%Int %"$0"), !stdlib.call.optim !0
  ret void
}
