...
entry:
  ...
  %3 = bitcast %Foo.refcounted* %storage to %RefcountedObject*
  call void @vist_releaseUnretainedObject(%RefcountedObject* %3)
  %4 = load %Foo.refcounted* %storage
  ret %Foo.refcounted %4
}
