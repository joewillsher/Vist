...
entry:
  ...
  %1 = bitcast %Foo.refcounted* %storage to %RefcountedObject*
  call void @vist_retainObject(%RefcountedObject* %1)
  %2 = getelementptr inbounds %Foo.refcounted* %storage, i32 0, i32 0
  %storage.instance = load %Foo** %2
  %a = getelementptr inbounds %Foo* %storage.instance, i32 0, i32 0
  store %Int %q, %Int* %a
  %3 = call %String @String_topi64(i8* getelementptr inbounds ([9 x i8]* @0, i32 0, i32 0), i64 9), !stdlib.call.optim !0
  call void @print_tString(%String %3), !stdlib.call.optim !0
  %4 = bitcast %Foo.refcounted* %storage to %RefcountedObject*
  call void @vist_releaseUnretainedObject(%RefcountedObject* %4)
  %5 = load %Foo.refcounted* %storage
