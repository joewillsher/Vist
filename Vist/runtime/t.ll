...
define void @incrementRefCount(i32 %refCount) #0 {
  ...
  store i32 %refCount, i32* %1, align 4
  store i32 1, i32* %2, align 4
  %6 = load i32, i32* %2, align 4
  %7 = atomicrmw add i32* %1, i32 %6 monotonic
  store i32 %7, i32* %3, align 4
  %8 = load i32, i32* %3, align 4
  store i32 %8, i32* %oldval, align 4
  store i32 1, i32* %4, align 4
  %9 = load i32, i32* %4, align 4
  %10 = atomicrmw sub i32* %1, i32 %9 monotonic
...
; Function Attrs: nounwind ssp uwtable
define void @decrementRefCount(i32 %refCount) #0 {
  %1 = alloca i32, align 4
  %oldval = alloca i32, align 4
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  ...
  store i32 1, i32* %2, align 4
  %6 = load i32, i32* %2, align 4
  %7 = atomicrmw sub i32* %1, i32 %6 monotonic
  store i32 %7, i32* %3, align 4
  %8 = load i32, i32* %3, align 4
  store i32 %8, i32* %oldval, align 4
  store i32 1, i32* %4, align 4
...
define i8* @vist_allocObject(i32 %size) #1 {
  %1 = alloca i32, align 4
...
define void @vist_releaseObject(%struct.RefcountedObject* %object, i32 %size) #1 {
  ...
  %4 = getelementptr inbounds %struct.RefcountedObject, %struct.RefcountedObject* %3, i32 0, i32 1
  %5 = load i32, i32* %4, align 8
  %6 = icmp eq i32 %5, 1
  br i1 %6, label %7, label %9

; <label>:7                                       ; preds = %0
  %8 = load %struct.RefcountedObject*, %struct.RefcountedObject** %1, align 8
  call void @vist_deallocObject(%struct.RefcountedObject* %8)
  br label %10
