...
; Function Attrs: noinline ssp uwtable
define void @"$print_f64"(double %d) #0 {
...
; Function Attrs: noinline ssp uwtable
define void @"$print_f32"(float %d) #0 {
...
; Function Attrs: noinline ssp uwtable
define void @"$print_b"(i1 zeroext %b) #0 {
  %1 = alloca i8, align 1
  %2 = zext i1 %b to i8
