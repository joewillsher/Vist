...
entry:
  ...
  %.fca.1.0.insert = insertvalue %Range.st %.fca.0.0.insert, i64 %1, 1, 0
...
; Function Attrs: nounwind readnone
define %Int32.st @Int32_i32(i32 %"$0") #2 {
entry:
...
; Function Attrs: nounwind readnone
define %Double.st @Double_f64(double %"$0") #2 {
entry:
...
; Function Attrs: nounwind readnone
define %Bool.st @-O-O_Bool_Bool(%Bool.st, %Bool.st) #2 {
...
; Function Attrs: nounwind readnone
define %Double.st @-P_Double_Double(%Double.st, %Double.st) #2 {
