...
entry:
  %Int = alloca %Int.ty
  %Int.value.ptr = getelementptr inbounds %Int.ty* %Int, i32 0, i32 0
  store i64 %v, i64* %Int.value.ptr
  %Int1 = load %Int.ty* %Int
  ret %Int.ty %Int1
}
...
entry:
  %Int = alloca %Int.ty
  %0 = call %Int.ty @_Int_i64(i64 0), !stdlib.call.optim !2
  %v = alloca %Int.ty
  store %Int.ty %0, %Int.ty* %v
  %v.value.ptr = getelementptr inbounds %Int.ty* %v, i32 0, i32 0
...
; Function Attrs: alwaysinline
define %Int.ty @_Int_i641(i64 %"$0") #2 {
entry:
  %Int = alloca %Int.ty
  %Int.value.ptr = getelementptr inbounds %Int.ty* %Int, i32 0, i32 0
...
entry:
  %Int32 = alloca %Int32.ty
  %Int32.value.ptr = getelementptr inbounds %Int32.ty* %Int32, i32 0, i32 0
  store i32 %v, i32* %Int32.value.ptr
  %Int321 = load %Int32.ty* %Int32
  ret %Int32.ty %Int321
}

; Function Attrs: alwaysinline
define %Int32.ty @_Int32_i322(i32 %"$0") #2 {
entry:
  %Int32 = alloca %Int32.ty
  %Int32.value.ptr = getelementptr inbounds %Int32.ty* %Int32, i32 0, i32 0
...
entry:
  %Bool = alloca %Bool.ty
  %Bool.value.ptr = getelementptr inbounds %Bool.ty* %Bool, i32 0, i32 0
  store i1 %v, i1* %Bool.value.ptr
  %Bool1 = load %Bool.ty* %Bool
  ret %Bool.ty %Bool1
}
...
entry:
  %Bool = alloca %Bool.ty
  %0 = call %Bool.ty @_Bool_b(i1 false), !stdlib.call.optim !2
  %b = alloca %Bool.ty
  store %Bool.ty %0, %Bool.ty* %b
  %b.value.ptr = getelementptr inbounds %Bool.ty* %b, i32 0, i32 0
...
; Function Attrs: alwaysinline
define %Bool.ty @_Bool_b3(i1 %"$0") #2 {
entry:
  %Bool = alloca %Bool.ty
  %Bool.value.ptr = getelementptr inbounds %Bool.ty* %Bool, i32 0, i32 0
...
entry:
  %Double = alloca %Double.ty
  %Double.value.ptr = getelementptr inbounds %Double.ty* %Double, i32 0, i32 0
  store double %v, double* %Double.value.ptr
  %Double1 = load %Double.ty* %Double
  ret %Double.ty %Double1
}

; Function Attrs: alwaysinline
define %Double.ty @_Double_f644(double %"$0") #2 {
entry:
  %Double = alloca %Double.ty
  %Double.value.ptr = getelementptr inbounds %Double.ty* %Double, i32 0, i32 0
...
entry:
  %Range = alloca %Range.ty
  %Range.start.ptr = getelementptr inbounds %Range.ty* %Range, i32 0, i32 0
  store %Int.ty %"$0", %Int.ty* %Range.start.ptr
  %Range.end.ptr = getelementptr inbounds %Range.ty* %Range, i32 0, i32 1
  store %Int.ty %"$1", %Int.ty* %Range.end.ptr
  %Range1 = load %Range.ty* %Range
  ret %Range.ty %Range1
}

; Function Attrs: alwaysinline
define %Range.ty @_Range_Int_Int5(%Int.ty %"$0", %Int.ty %"$1") #2 {
entry:
  %Range = alloca %Range.ty
  %Range.start.ptr = getelementptr inbounds %Range.ty* %Range, i32 0, i32 0
  store %Int.ty %"$0", %Int.ty* %Range.start.ptr
...
; Function Attrs: alwaysinline
define void @_print_Int(%Int.ty %a) #2 {
entry:
...
; Function Attrs: alwaysinline
define void @_print_Int32(%Int32.ty %a) #2 {
entry:
...
; Function Attrs: alwaysinline
define void @_print_Bool(%Bool.ty %a) #2 {
entry:
...
; Function Attrs: alwaysinline
define void @_print_Double(%Double.ty %a) #2 {
entry:
...
; Function Attrs: alwaysinline
define void @_assert_Bool(%Bool.ty %"$0") #2 {
entry:
...
entry:
  %Bool_res = call %Bool.ty @_Bool_b(i1 %"$0")
  %0 = extractvalue %Bool.ty %Bool_res, 0
...
entry:
  ...
  %Int_res = call %Int.ty @_Int_i64(i64 %v.0)
  ret %Int.ty %Int_res
}
...
entry:
  ...
  %Int_res = call %Int.ty @_Int_i64(i64 %div_res)
  ret %Int.ty %Int_res
}
...
entry:
  ...
  %Int_res = call %Int.ty @_Int_i64(i64 %rem_res)
  ret %Int.ty %Int_res
}
...
entry:
  ...
  %Bool_res = call %Bool.ty @_Bool_b(i1 %cmp_lt_res)
  ret %Bool.ty %Bool_res
}
...
entry:
  ...
  %Bool_res = call %Bool.ty @_Bool_b(i1 %cmp_lte_res)
  ret %Bool.ty %Bool_res
}
...
entry:
  ...
  %Bool_res = call %Bool.ty @_Bool_b(i1 %cmp_gt_res)
  ret %Bool.ty %Bool_res
}
...
entry:
  ...
  %Bool_res = call %Bool.ty @_Bool_b(i1 %cmp_gte_res)
  ret %Bool.ty %Bool_res
}
...
entry:
  ...
  %Bool_res = call %Bool.ty @_Bool_b(i1 %cmp_eq_res)
  ret %Bool.ty %Bool_res
}
...
entry:
  ...
  %Bool_res = call %Bool.ty @_Bool_b(i1 %cmp_neq_res)
  ret %Bool.ty %Bool_res
}
...
entry:
  ...
  %Bool_res = call %Bool.ty @_Bool_b(i1 %cmp_and_res)
  ret %Bool.ty %Bool_res
}
...
entry:
  ...
  %Bool_res = call %Bool.ty @_Bool_b(i1 %cmp_or_res)
  ret %Bool.ty %Bool_res
}
...
entry:
  ...
  %Double_res = call %Double.ty @_Double_f64(double %add_res)
  ret %Double.ty %Double_res
}
...
entry:
  ...
  %Double_res = call %Double.ty @_Double_f64(double %sub_res)
  ret %Double.ty %Double_res
}
...
entry:
  ...
  %Double_res = call %Double.ty @_Double_f64(double %mul_res)
  ret %Double.ty %Double_res
}
...
entry:
  ...
  %Double_res = call %Double.ty @_Double_f64(double %div_res)
  ret %Double.ty %Double_res
}
...
entry:
  ...
  %Double_res = call %Double.ty @_Double_f64(double %rem_res)
  ret %Double.ty %Double_res
}
...
entry:
  %Range_res = call %Range.ty @_Range_Int_Int(%Int.ty %a, %Int.ty %b)
  ret %Range.ty %Range_res
}

; Function Attrs: alwaysinline
define %Range.ty @"_..<_Int_Int"(%Int.ty %a, %Int.ty %b) #2 {
entry:
  %0 = call %Int.ty @_Int_i64(i64 1), !stdlib.call.optim !2
  %-.res = call %Int.ty @_-_Int_Int(%Int.ty %b, %Int.ty %0)
  %Range_res = call %Range.ty @_Range_Int_Int(%Int.ty %a, %Int.ty %-.res)
  ret %Range.ty %Range_res
}
