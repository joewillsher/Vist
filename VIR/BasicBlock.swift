...
//func ==(l: Inst, r: Inst) -> Bool {
//    return l === r
//}
//
//extension BasicBlock : Collection {
//    
//    typealias Iterator = IndexingIterator<[Inst]>
//    
//    func makeIterator() -> Iterator {
//        return instructions.makeIterator()
//    }
//    
//    var isEmpty: Bool { return instructions.isEmpty }
//    var count: Int { return instructions.count }
//    
//    var first: Iterator.Element? { return instructions.first }
//    var last: Iterator.Element? { return instructions.last }
//    
//    var startIndex: Int { return instructions.startIndex }
//    var endIndex: Int { return instructions.endIndex }
//    
//    subscript(_ i: Inst) -> Iterator.Element {
//        get {
//            return instructions.first(where: {$0 === i})!
//        }
//        set(i) {
//            let index = instructions.index(where: {$0 === i})!
//            instructions[index] = i
//        }
//    }
//    
//    subscript(_ r: Range<Int>) -> Range<Inst> {
//        get {
//            return instructions[r]
//        }
//        set(r) {
//            let start = instructions.index(where: {$0 === r.start})!
//            let end = instructions.index(where: {$0 === r.end})!
//            instructions[index] = i
//        }
//    }
//}
